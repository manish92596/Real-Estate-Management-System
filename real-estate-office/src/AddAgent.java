...
public class AddAgent extends JFrame {
	...
	public static void insertnewagent(String id, String name, String password, String email, String address,
		...
		try {
			...
			SQL = "insert into agent" + "(A_id,A_name,A_password,A_email,A_address,A_username,A_contact_no)"
	...
	public AddAgent() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// if (id.isBlank() || name.isBlank() || password.isBlank() || email.isBlank()
				// || address.isBlank()
				// || username.isBlank() || contact.isBlank()) {
				// JOptionPane.showMessageDialog(null, "Enter All Information", "Warning",
				// JOptionPane.WARNING_MESSAGE);

				// }
				if (id.isEmpty() || name.isEmpty() || password.isEmpty() || email.isEmpty() || address.isEmpty()
						|| username.isEmpty() || contact.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Enter All Information", "Warning",
							JOptionPane.WARNING_MESSAGE);
				} else {
				...
				gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
										...
										.addComponent(lblEmail, GroupLayout.PREFERRED_SIZE, 80,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblAddress, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(lblUsername, GroupLayout.PREFERRED_SIZE, 80,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lblContactNo, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE)
										.addComponent(lblId, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
												Short.MAX_VALUE))
								.addGap(58)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
