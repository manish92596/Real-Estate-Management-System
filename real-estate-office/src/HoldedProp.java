...
public class HoldedProp extends JFrame {
    ...
    public HoldedProp() {
        ...
        try {
            ...
            // Create a statement and execute the SQL query
            Statement stmt = conn.createStatement();
            String query = "select manages.P_id,flat_type,p_name,p_type,sell_rent,p_area,y_o_c,s_price_r_price,p_address,status from property,manages where property.p_id=manages.p_id and a_id='"
                    + v1 + "'";
        ...
        // if(fac==null)
        // {
        // JOptionPane.showMessageDialog(null,"Please Select a Property to
        // continue","Warning",JOptionPane.WARNING_MESSAGE);
        // }
        // else
        // {
        // // update(fac);
        // JOptionPane.showMessageDialog(null,"Property
        // Sold","Information",JOptionPane.INFORMATION_MESSAGE);
        // }
        // }
        // });
        ...
        // JLabel label = new JLabel("Select a Property and click on continue to confirm
